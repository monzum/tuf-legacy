...
def create_roledb_from_root_metadata(root_metadata):
  ...
  <Side Effects>
    Calls add_role().
    The old 'roledb_dict' role database is replaced.
  ...
  # and add them to 'roledb_dict'.  Duplicates are avoided.
...
def add_role(rolename, roleinfo, require_parent=True):
  ...
  <Side Effects>
    The 'roledb_dict' role database is modified.
  ...
  if require_parent and '/' in rolename:
    ...
    if parent_role not in roledb_dict:
      raise tuf.Error("Parent role does not exist: "+parent_role)

  roledb_dict[rolename] = roleinfo
...
def role_exists(rolename):
  ...
  return rolename in roledb_dict
...
def remove_role(rolename):
  ...
  <Side Effects>
    A role from the 'roledb_dict' role database is deleted.
...
def remove_delegated_roles(rolename):
  ...
  <Side Effects>
    Role(s) from the 'roledb_dict' role database deleted.
...
def _check_rolename(rolename):
  ...
  if rolename not in roledb_dict:
